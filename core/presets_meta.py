...
PRESET_CATEGORIES = {
    ...
    "?뫍 Duo Glamour": [
        ...
        "duo_sunset_silhouette", "duo_desert_minimal", "duo_kpop_stage", "duo_penthouse_power", "duo_ice_bath_contrast", "duo_penthouse_black", "duo_pool_wet_night", "duo_couture_sheer",
